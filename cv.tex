...
\useURL[latestcv][https://github.com/syhan/cv/raw/master/cv.pdf][][Link]
...
\item Proficient in Object & Orient Design, Functional Programming and Database Development
\item Familiar with Java, ECMAScript, Python, Ruby, Scala, SQL, etc.
\item Experience in Big Data stack, skilled on Spark, Kafka, Cassandra, ElasticSearch, CloudFoundry, AWS, etc.
\item Skills on Shell scripting, Linux, Scrum/Agile, git, Maven, Markdown, etc.
\item Domain knowledge on SAP ERP, EM, TM, etc.
%\item 4 filed patents on database, framework area.
\stopitemize
...
%\noindent
%\startalignment[middle]
%{\tfxx Last updated: \date~\bullet~<\from[email]>\crlf Built by \ConTeXt}
%\stopalignment
